<%-- 
    ...
    Created on : 10 may. 2020, 18:49:12
    Author     : Georgina
--%>
...
<html>
    ...
    <body>
        ...
        <form class="form" accept-charset="UTF-8" method="post" action=<c:url value="/loadDocument"/>
            <div class="col-lg-6">
                <div class="input-group">
                    <input name="doc" Placeholder=" Ingrese la URL del Documento..." type="text"  value="${url}" class="form-control"/>
